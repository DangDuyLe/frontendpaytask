                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-gray-900">Your Wallet</div>
                        ...
                        <TableRow key={tx.id} className="hover:bg-gray-50">
                          <TableCell>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="capitalize text-gray-900 font-medium">{tx.type}</span>
                            </div>
                          </TableCell>
                          ...
                          <TableCell className={`text-right font-semibold ${tx.type === "credit" ? "text-[#20A277]" : "text-gray-900"}`}>
