              ...
              <Card className="border-gray-200 shadow-sm">
                <CardContent className="p-6">
                  ...
                  <Tabs defaultValue="description" className="w-full">
                    <TabsList className={`grid w-full ${userRole === 'client' ? 'grid-cols-2' : 'grid-cols-2'} bg-gray-100`}>
                      ...
                      {userRole === "client" && (
                        <TabsTrigger value="review" className="data-[state=active]:bg-white">
                          Review Submission {submissionDetail && <span className="inline-block w-2 h-2 bg-blue-600 rounded-full ml-2"></span>}
                        </TabsTrigger>
                      )}
                    </TabsList>
                      ...
                      {submissionDetail ? (
                        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                          ...
                          <p className="text-sm text-green-700">
                            Your work was submitted on {new Date(submissionDetail.submittedAt).toLocaleString()}
                            and is currently {submissionDetail.status}.
                          </p>
                        </div>
                      ) : (
                        <>
